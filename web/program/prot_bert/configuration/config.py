...
def get_train_config():
    ...
    parse.add_argument('input-path', type=str, help='The input file path')
    parse.add_argument('output-path', type=str, help='The output file path')
    # preoject setting
    ...
    # training parameters
    # parse.add_argument('-b', type=float, default=0.6, help='flooding method threshold')
    ...
    parse.add_argument('-batch-size', type=int, default=1, help='number of samples in a batch')
    # parse.add_argument('-batch-size', type=int, default=16, help='number of samples in a batch')
    parse.add_argument('-epoch', type=int, default=6, help='number of iteration')
