...
class BERT(nn.Module):
    def __init__(self):
        ...
        self.tokenizer = BertTokenizer.from_pretrained('/usr/local/tomcat/webapps/PepBCL/program/prot_bert_bfd', do_lower_case=False)
        self.bert = BertModel.from_pretrained("/usr/local/tomcat/webapps/PepBCL/program/prot_bert_bfd")
        # freeze_bert(self)
